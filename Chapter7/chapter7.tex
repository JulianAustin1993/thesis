...
\begin{table}
	\caption[Results for the PS variable on full data in the Globe study.]{Results for reconstruction of the full data for the PS variable in the globe study from the CESM-LE dataset. Bold indicates best in class.}
	\centering
...
\begin{table}
	\caption[Results for the U10 variable on validation data in the Globe study.]{Results for reconstruction of the validation data for the U10 variable in the globe study from the CESM-LE dataset. Bold indicates best in class.}
	\centering
